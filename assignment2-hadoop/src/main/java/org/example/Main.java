...
public class Main {
    public static void main(String[] args){
        ...
        HadoopJarStepConfig hadoopJarStepmapreducer1 = HadoopJarStepConfig.builder()
                .jar("s3://ofiwjoiwf/1assignment2-jar-with-dependencies.jar")
                .mainClass("com.exmaple.MapperReducer1")
                .args("s3://datasets.elasticmapreduce/ngrams/books/20090715/heb-all/3gram/data","s3://ofiwjoiwf/map1output")
                .build();

        HadoopJarStepConfig hadoopJarStepmapreducer2 = HadoopJarStepConfig.builder()
                .jar("s3://ofiwjoiwf/2assignment2-jar-with-dependencies.jar")
        ...
        HadoopJarStepConfig hadoopJarStepmapreducer3 = HadoopJarStepConfig.builder()
                .jar("s3://ofiwjoiwf/3assignment2-jar-with-dependencies.jar")
